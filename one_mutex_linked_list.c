...
void *threadFunction(void *dummyPt) {
    ...
    while (local_count < local_total) {
        ...
        /*
         * If the flag for a particular operation is false the mutex is obtained until the
         * operation is done. Then the mutex is unlocked. After that local operation count
         * and total count are incremented.
         */
